        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a href="#" class="d-block">Nama Superadmin</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('superadmin/daftaradmin') }}" class="nav-link bg-success">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('superadmin/daftardestinasi') }}" class="nav-link bg-warning">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('superadmin/daftarmenu') }}" class="nav-link bg-info">
