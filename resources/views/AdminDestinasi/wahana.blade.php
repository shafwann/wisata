        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <a href="{{ url('admin-destinasi/wahana/tambah') }}" class="btn btn-primary">Tambah Wahana</a>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            <!-- /.content-header -->
                                        ...
                                        <div class="row">
                                            <div class="carousel slide col-sm-6" data-ride="carousel">
                                                @foreach (explode('|', $w['foto_wahana']) as $key => $image)
                                                    <div
                                                        class="col-sm-6 carousel-item {{ $key == 0 ? 'active' : '' }}">
                                        ...
                                        <div class="hover_Text d-flex align-items-end justify-content-between">
                                            <div class="row">
                                                <div class="hover_text_iner col-sm-6">
                                                    <a href="{{ url('/admin-destinasi/wahana/edit', $w->id) }}"><i
                                                            class="fas fa-edit"></i></a>
                                                </div>
                                                <div class="hover_text_iner col-sm-6">
                                                    <a href="{{ url('/admin-destinasi/wahana/hapus', $w->id) }}"><i
