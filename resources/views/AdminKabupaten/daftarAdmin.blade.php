        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <a href="{{ url('admin-kabupaten/daftar-admin/tambah') }}" class="btn btn-primary">Tambah
                            Admin
                        </a>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                ...
                                <tbody>
                                    @foreach ($admin['data'] as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('admin-kabupaten/daftar-admin/edit/' . $data['id']) }}"
                                                    class="btn btn-warning">Edit</a>
                                                <a href="{{ url('admin-kabupaten/daftar-admin/hapus/' . $data['id']) }}"
