    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <form action="{{ url('admin-kabupaten/proses-edit-profil', $profil['data']['admin_id']) }}"
                        class="card card-default" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama_kabupaten"
                                        value="{{ $profil['data']['nama_kabupaten'] }}"
                                        placeholder="Masukkan Nama Kabupaten">
                                </div>
                            </div>
                            <div class="form-group row">
                                {{-- <img src="{{ url('images/' . $profil['data']['foto_kabupaten']) }}" alt=""
                                    style="height: 250px; width: 250px;">
                                <input type="image" class="form-control" name="foto_kabupaten"
                                    value="{{ $profil['data']['foto_kabupaten'] }}"
                                    placeholder="Masukkan Nama Kabupaten"> --}}
                                <label for="fotoDestinasi" class="col-sm-2 col-form-label">Foto</label>
                                <div class="input-group col-sm-10">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="fotoDestinasi"
                                            name="foto_kabupaten">
                                        <label class="custom-file-label" for="fotoDestinasi">Choose file</label>
                                    </div>
                                    <div class="input-group-append">
